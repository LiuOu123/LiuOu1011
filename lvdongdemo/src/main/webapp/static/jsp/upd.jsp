...
<form action="/doupdate" method="post" enctype="multipart/form-data">
    <input hidden value="${standard.id}" name="id">
    <table border="1px" align="center" width="500px">
        ...
        <tr>
            ...
            <td><input type="text" name="releaseDate">
                <span hidden class="releaseDate"><fmt:formatDate value="${standard.releaseDate}" pattern="yyyy-MM-dd"></fmt:formatDate></span>
            </td>
        </tr>
        <tr>
            <td>实施日期(yyyy-MM-dd)：</td>
            <td><input type="text" name="implDate">
                <span hidden class="implDate"><fmt:formatDate value="${standard.implDate}" pattern="yyyy-MM-dd"></fmt:formatDate></span>
            </td>
        </tr>
        <tr>
...
<script type="text/javascript">
    $(function () {
        ...
        $("input[name=releaseDate]").val(releaseDate);
        var implDate=$(".implDate").text();
        $("input[name=implDate]").val(implDate);
    })
